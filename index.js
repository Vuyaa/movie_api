...
let top10Movies = [
  {
    ...
    imgURL:"https://upload.wikimedia.org/wikipedia/en/8/8a/The_Lord_of_the_Rings_The_Fellowship_of_the_Ring_%282001%29.jpg",
    author: {
      name: "Peter Jackson",
      biography:
...

  {
    ...
    imgURL:"https://a2.tvspielfilm.de/imedia/9009/10509009,9+nuNdU8aWFKNXe32RmmKWv+oB9lYjGLrBK55Dra3fbZUFZ3+nn+fq5Fi_f_oWjZpajlQ0wForoC0kXLmgQRaw==.jpg",
    author: {
      name: "David Yates",
      biography:
...

  {
    ...
    imgURL:"https://upload.wikimedia.org/wikipedia/en/b/be/The_Maze_Runner_poster.jpg",
    author: {
      name: "Wes Ball",
      biography:
...

  {
    ...
    imgURL:"https://i.ytimg.com/an/Mj9IA9tTfio/7642531020657881441_mq.jpg?v=5f5bf0ff",
    author:{
...

  {
    ...
    description:"Stars Tom Hanks as a death row corrections officer during the U.S. Great Depression who witnesses supernatural events that occur after an enigmatic inmate (Michael Clarke Duncan) is brought to his facility. It's just another normal day on the Green Mile for prison guard Paul Edgecomb.",
    imgURL:"https://upload.wikimedia.org/wikipedia/en/e/e2/The_Green_Mile_%28movie_poster%29.jpg",
    author:{
      name: "Frank Darabont",
      biography:
        "Frank Árpád Darabont (born Ferenc Árpád Darabont, January 28, 1959) is an American film director, screenwriter and producer. He has been nominated for three Academy Awards and a Golden Globe Award. In his early career, he was primarily a screenwriter for such horror films as A Nightmare on Elm Street 3: Dream Warriors (1987), The Blob (1988) and The Fly II (1989). As a director, he is known for his film adaptations of Stephen King novellas and novels, such as The Shawshank Redemption (1994), The Green Mile (1999), and The Mist (2007)."
...

  {
    ...
    imgURL:"https://m.media-amazon.com/images/M/MV5BYzFjMThiMGItOWRlMC00MDI4LThmOGUtYTNlZGZiYWI1YjMyXkEyXkFqcGdeQXVyMjUzOTY1NTc@._V1_.jpg",
    author:{
...

  {
    ...
    description:"In 1954, a U.S. Marshal investigates the disappearance of a murderer who escaped from a hospital for the criminally insane. In 1954, up-and-coming U.S. marshal Teddy Daniels is assigned to investigate the disappearance of a patient from Boston's Shutter Island Ashecliffe Hospital.",
    imgURL:"https://m.media-amazon.com/images/M/MV5BYzhiNDkyNzktNTZmYS00ZTBkLTk2MDAtM2U0YjU1MzgxZjgzXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg",
    author:{
...
app.get('/movies/directors/:authorName', (req, res) => {
  ...
  const author = top10Movies.find(movie => movie.author.name === authorName).author;
